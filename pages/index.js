      ...
      <main className="bg-white min-h-screen">
        ...
        <section className="max-w-4xl mx-auto px-4 py-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-6">
            ...
            <Link href="/demo" className="bg-white border border-green-600 text-green-600 hover:bg-green-50 font-semibold px-8 py-4 rounded-lg text-lg transition">
              Try Demo
            </Link>
          </div>
        ...
        <section className="max-w-5xl mx-auto px-4 py-12 grid md:grid-cols-2 gap-10">
          <div>
            ...
            <Link href="/signup" className="mt-8 inline-block bg-green-600 hover:bg-green-700 text-white font-semibold px-8 py-4 rounded-lg text-lg shadow transition">
              Start Tracking Free
            </Link>
          </div>
          <div>
